...
\begin{DESCRIPTION}
  ...
  \item [figures] Directory for your images. Currently contains \texttt{placeholder.pdf} (a.k.a TODO image -- see below) and image keep-calm.png to demonstrate inserting raster images (you don't submit these images with your thesis). It is advised to use shorter directory name, so that it is only in your chosen language.
...
\begin{figure*}[h]\centering
  \centering
  \includegraphics[width=\linewidth,height=1.7in]{figures/placeholder.pdf}\\[1pt]
  \includegraphics[width=0.24\linewidth]{figures/placeholder.pdf}\hfill
  \includegraphics[width=0.24\linewidth]{figures/placeholder.pdf}\hfill
  \includegraphics[width=0.24\linewidth]{figures/placeholder.pdf}\hfill
  \includegraphics[width=0.24\linewidth]{figures/placeholder.pdf}
...
\begin{figure}[hbt]
	\centering
	\includegraphics[width=0.3\textwidth]{figures/keep-calm.png}
