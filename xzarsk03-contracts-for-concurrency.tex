...
\projectinfo{
  ...
  v jazyce Java vůči kontraktům. Analyzátor podporuje parametrické kontrakty se
  ...
  RoadRunner framework. As a part of the solution, support for accessing the
  method arguments and return values was added to RoadRunner. The analyzer was
