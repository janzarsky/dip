...
thread interleavings violate the contract. To verify that a~program satisfies
the restrictions given by contracts for concurrency, one may use either static
or dynamic analysis, both offering different advantages.
