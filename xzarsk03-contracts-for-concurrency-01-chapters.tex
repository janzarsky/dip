...
The typical class transformation uses the following architecture (see
Figure~\ref{asmArchitecture}): a \texttt{ClassReader} instance reads the class,
then one or more \texttt{ClassVisitor} instances modify the class, and then a
