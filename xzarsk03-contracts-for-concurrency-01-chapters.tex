...
%There is a~dynamic analyzer implementation for parametric contracts with
%spoilers in the ANaConDA framework for programs written in C/C++. The thesis
...
When executing, on each method invocation, the Java Virtual Machine creates
...
The test case was run using the RoadRunner benchmark mode. The measured results
