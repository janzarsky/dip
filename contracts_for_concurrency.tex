...
\projectinfo{
  ...
  keywords.cs={verifikace software, dynamická analýza, Java, kontrakty pro
  ...
  built upon the RoadRunner framework. \todo{results}},
  declaration={I hereby declare that this diploma thesis was prepared as an
  original work by the author under the supervision of Ing. Aleš Smrčka, Ph.D.
  The supplementary information was provided by \todo{TODO} I have listed all
  the literary sources, publications and other sources, which were used during
  the preparation of this thesis.},
  acknowledgment={\todo{TODO}},
  extendedabstract={\todo{TODO}},
...
\begin{document}
  ...
  % ----------------------------------------------
  \input{contracts_for_concurrency-01-chapters}
...
\fi
  ...
  % Přílohy / Appendices
  \input{contracts_for_concurrency-30-appendices}
