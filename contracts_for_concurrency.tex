...
\projectinfo{
  ...
  title.en={Parametric Contracts for Concurrency in Java Programs}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Žárský},   % příjmení autora / author surname 
